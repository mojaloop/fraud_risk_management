...
const getTransfersFromILPsArray = async (
...
const handleTransactionsBetweenParties = async (
  ...
  const tier1Payees = await getTransfersFromILPsArray(
  ...
  if (tier1Payees !== undefined) {
    ...
    const tier2Payees = await getTransfersFromILPsArray(
      outgoingTransfersClient,
    ...
    if (tier2Payees !== undefined) {
      ...
      const tier3Payees = await getTransfersFromILPsArray(
        outgoingTransfersClient,
