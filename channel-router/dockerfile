...
ENV FUNCTION_NAME=channel-router
ENV NODE_ENV=dev
ENV PORT=3000
ENV CHANNEL_MAP='[{"name":"Channel1", "endpoint": "http://20.90.137.195:8080/function/off-channel-orchestrator.frm/Execute"}]'
 
ENV APM_LOGGING=false
ENV APM_SERVICE_NAME=channel-router
ENV APM_URL=127.0.0.1:4857
ENV APM_SECRET_TOKEN=secrettokenhere
